          ...
          <div id="toggle">
            ...
            <nav>
              <ul class='navbar-links nav-menu'>
                ...
                <li class="nav-item secondary"><a class='nav-link' href="./about.html">ABOUT</a></li>
                <li class="nav-item secondary"><a class='nav-link' href="./faqs.html">FAQs / DIY</a></li>
                <li class="nav-item secondary"><a class='nav-link' href="https://square.site/book/L98NPR7TF8NX2/knight-vision-inspection" class='bk-btn'>BOOK NOW</a></li>
    
                  <div class="mobile-social-nav">
                    <li><a href="mailto:knightvisionco@gmail.com"><i class="fa-solid fa-paper-plane  tooltip"><span class="tooltiptext">Mail</span></i></a></li>
                    <li><a href="tel:303-718-3046"><i class="fa-solid fa-phone  tooltip"><span class="tooltiptext">Phone</span></i></a></li>
                    <li><a href="https://www.facebook.com/login/?next=https%3A%2F%2Fwww.facebook.com%2FKnightVisionInspection"><i class="fa-brands fa-facebook tooltip"><span class="tooltiptext">Facebook</span></i></a></li>
                    <li><a href="https://www.facebook.com/login/?next=https%3A%2F%2Fwww.facebook.com%2FKnightVisionInspection"><i class="fa-brands fa-facebook-messenger tooltip"><span class="tooltiptext">FBMessenger</span></i></a></li>
                    <li><a href="https://square.site/book/L98NPR7TF8NX2/knight-vision-inspection"><i class="fa-solid fa-calendar-check tooltip"> <span class="tooltiptext">BOOK NOW</span></i></a></li>
                  </div>  
